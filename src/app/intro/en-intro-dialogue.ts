export const EN_INTRO_DIALOGUE: string[] = [
	...
	'It is called the PTSU, which stands for Psychoelectric Telepathic Suggestion Chip.',
	'The PTSU sends psychoelectric waves into your brain that change the things the brands that you prefer to buy without you ever knowing.',
